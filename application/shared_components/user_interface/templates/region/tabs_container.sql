...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(55082330830680502)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(55082630536680503)
,p_plug_template_id=>wwv_flow_api.id(55082330830680502)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(55082942047680503)
,p_plug_template_id=>wwv_flow_api.id(55082330830680502)
,p_name=>'Tabs'
