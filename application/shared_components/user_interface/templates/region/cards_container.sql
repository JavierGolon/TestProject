...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(55025580393680395)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(55025885901680396)
,p_plug_template_id=>wwv_flow_api.id(55025580393680395)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(55026135199680396)
,p_plug_template_id=>wwv_flow_api.id(55025580393680395)
,p_name=>'Sub Regions'
