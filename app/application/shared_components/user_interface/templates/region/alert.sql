...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(55013203653680352)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(55013563596680373)
,p_plug_template_id=>wwv_flow_api.id(55013203653680352)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(55013808082680376)
,p_plug_template_id=>wwv_flow_api.id(55013203653680352)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(55014154505680377)
,p_plug_template_id=>wwv_flow_api.id(55013203653680352)
,p_name=>'Create'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(55014425222680377)
,p_plug_template_id=>wwv_flow_api.id(55013203653680352)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(55014741526680378)
,p_plug_template_id=>wwv_flow_api.id(55013203653680352)
,p_name=>'Previous'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(55015067100680378)
,p_plug_template_id=>wwv_flow_api.id(55013203653680352)
,p_name=>'Sub Regions'
