...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(55068583595680475)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(55068882884680475)
,p_plug_template_id=>wwv_flow_api.id(55068583595680475)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(55069161568680476)
,p_plug_template_id=>wwv_flow_api.id(55068583595680475)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(55069481550680476)
,p_plug_template_id=>wwv_flow_api.id(55068583595680475)
,p_name=>'Previous'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(55069700789680477)
,p_plug_template_id=>wwv_flow_api.id(55068583595680475)
,p_name=>'Sub Regions'
