...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(55050733582680442)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(55051036488680443)
,p_plug_template_id=>wwv_flow_api.id(55050733582680442)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(55051338646680443)
,p_plug_template_id=>wwv_flow_api.id(55050733582680442)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(55051673447680444)
,p_plug_template_id=>wwv_flow_api.id(55050733582680442)
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(55051998016680444)
,p_plug_template_id=>wwv_flow_api.id(55050733582680442)
,p_name=>'Sub Regions'
