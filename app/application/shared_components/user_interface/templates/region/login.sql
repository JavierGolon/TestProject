...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(55070376881680478)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(55070673544680479)
,p_plug_template_id=>wwv_flow_api.id(55070376881680478)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(55070969965680479)
,p_plug_template_id=>wwv_flow_api.id(55070376881680478)
,p_name=>'Create'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(55071264980680480)
,p_plug_template_id=>wwv_flow_api.id(55070376881680478)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(55071550396680480)
,p_plug_template_id=>wwv_flow_api.id(55070376881680478)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(55071860445680481)
,p_plug_template_id=>wwv_flow_api.id(55070376881680478)
,p_name=>'Sub Regions'
