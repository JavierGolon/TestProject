...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(55089792451680512)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(55090042688680513)
,p_plug_template_id=>wwv_flow_api.id(55089792451680512)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(55090387065680513)
,p_plug_template_id=>wwv_flow_api.id(55089792451680512)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(55090634072680514)
,p_plug_template_id=>wwv_flow_api.id(55089792451680512)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(55090911753680514)
,p_plug_template_id=>wwv_flow_api.id(55089792451680512)
,p_name=>'Previous'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(55091287351680515)
,p_plug_template_id=>wwv_flow_api.id(55089792451680512)
