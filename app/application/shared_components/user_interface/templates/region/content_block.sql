...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(55046500577680436)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(55046807633680437)
,p_plug_template_id=>wwv_flow_api.id(55046500577680436)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(55047143726680438)
,p_plug_template_id=>wwv_flow_api.id(55046500577680436)
,p_name=>'Change'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(55047485758680438)
,p_plug_template_id=>wwv_flow_api.id(55046500577680436)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(55047789377680438)
,p_plug_template_id=>wwv_flow_api.id(55046500577680436)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(55048047500680439)
,p_plug_template_id=>wwv_flow_api.id(55046500577680436)
,p_name=>'Previous'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(55048334460680439)
,p_plug_template_id=>wwv_flow_api.id(55046500577680436)
,p_name=>'Sub Regions'
