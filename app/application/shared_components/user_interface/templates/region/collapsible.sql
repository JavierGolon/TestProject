...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(55037011774680418)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(55037315885680418)
,p_plug_template_id=>wwv_flow_api.id(55037011774680418)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(55037637627680419)
,p_plug_template_id=>wwv_flow_api.id(55037011774680418)
,p_name=>'Change'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(55037900422680419)
,p_plug_template_id=>wwv_flow_api.id(55037011774680418)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(55038225940680419)
,p_plug_template_id=>wwv_flow_api.id(55037011774680418)
,p_name=>'Copy'
,p_placeholder=>'COPY'
,p_has_grid_support=>false
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(55038514389680420)
,p_plug_template_id=>wwv_flow_api.id(55037011774680418)
,p_name=>'Create'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(55038826320680422)
,p_plug_template_id=>wwv_flow_api.id(55037011774680418)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(55039101922680423)
,p_plug_template_id=>wwv_flow_api.id(55037011774680418)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(55039474068680423)
,p_plug_template_id=>wwv_flow_api.id(55037011774680418)
,p_name=>'Previous'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(55039769955680423)
,p_plug_template_id=>wwv_flow_api.id(55037011774680418)
,p_name=>'Sub Regions'
